        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="hidden-xs">{{$login_admin_user['name']}}</span>
                </a>
                <ul class="dropdown-menu">
                    <!-- User image -->
                    <li class="user-header">
                        ...
                        <p>
                            ...
                            <small>{{date('Y年m月d日',strtotime($login_admin_user['add_time']))}}加入</small>
                        </p>
                    </li>
                    <!-- Menu Body -->
                    {{--<li class="user-body">--}}
                    ...
                    <li class="user-footer">
                        <div class="pull-left">
                            <a href="/user/setting" class="btn btn-default btn-flat">设置</a>
                        </div>
