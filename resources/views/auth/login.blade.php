    ...
    <input type="hidden" name="_token" value="{{csrf_token()}}">
       ...
       @endif
        <div class="form-group" id="form-group-email">
          ...
          <div class="controls">
            <input type="text" id="email" name="email" value="{{Input::get('email')}}" required="required" class="form-control">
          </div>
        </div>
        ...
        <div class="form-group" id="form-group-password">
          ...
          <div class="controls">
            <input type="password" required="required" name="password" id="login_password" class="form-control">
          </div>
        </div>
          <div class="form-group">
            <div class="controls">
              <span class="checkbox mtm pull-right">
                <label>
                <input type="checkbox" name="remember" value="true"> 记住密码 </label>
              </span>
